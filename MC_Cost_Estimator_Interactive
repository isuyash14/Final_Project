...
'''
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
This script is used for MonteCarlo Simulation for Cost Risk analysis                       +
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
                                                                                           +
version  |  date     |  author   |  comment
--------------------------------------------------------------------------------------------
1.0      |  05/06/18 | suyash  | intial version.                                         +
--------------------------------------------------------------------------------------------
                                                                                           +
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
'''
...
### Take input from user for running simulations 


NoOfSim = int(input("Kindly enter the no of steps for simulation: "))


### Read input from command line and create a dictionary. 
...
### 
### Create the data frome from the dictionary 
...
### A function for creating sample from pert-distribution. 
### it takes the min, likely, max and no of samples as parameters. 
...
## Create a dataframe storing the Fixed Cost, Variable Cost, 
### Total cost of each task and also for the total cost of the project. 
...
### Create plots for total cost distribution for 
### each task . 
...
### Display the result for the Estimated Cost and Likely cost for each of the task. 
...
### Display the result for the Estimated Cost and Likely cost for the project. 

print("\n")

print(" -" * 60)
print("PROJECT LIKELY COST   |    PROJECT ESTIMATED COST    |    PROJECT MAX COST FOR SIMULATION")
print(" -" * 60)
print( str(df_project[-1:]["LikelyTC"].values[0])+ " " *25 + str(np.mean(sim_result['Project Cost'])) + " " * 25 + str(sim_result['Project Cost'].max()))
print(" -" * 60)
